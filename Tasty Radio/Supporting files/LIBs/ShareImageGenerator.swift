...
class ShareImageGenerator {
    ...
    func generate() -> UIImage {
        ...
        logoShareView.shareSetup(albumArt: track.artworkImage ?? #imageLiteral(resourceName: "logo"), radioShoutout: songToShare, trackTitle: track.title, trackArtist: track.artist)
        ...
        return shareImage ?? track.artworkImage ?? #imageLiteral(resourceName: "logo")
    }
}
